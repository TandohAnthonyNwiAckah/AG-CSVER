		...
		<table class="table table-sm">
			<tr>
				<th align="left" valign="middle">
					...
					<small class="sub-title">My  App</small>
				</th>
				<th align="right" valign="middle" width="40%">
		...
		<table class="table table-sm">
			<tr>
				<td align="left" valign="middle">
					Footer content goes here. To edit this page browse to ./resources/view/layout/report.blade.php
				</td>
			</tr>
		</table>
	</div>

                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Countries</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/countries"></q-breadcrumbs-el>
                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col">
                                            ...
                                            <template >
                                                ...
                                                :bordered="false"
                                                :columns="$menus.CountriesTableHeaderItems" 
                                                :data="records"
                                                binary-state-sort
                                                ...
                                                <template v-slot:body="props">
                                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-td  key="continent_code" :props="props">
                                                            {{ props.row.continent_code }}
                                                        </q-td>
                                                        <q-td  key="currency_code" :props="props">
                                                            {{ props.row.currency_code }}
                                                        </q-td>
                                                        <q-td  key="iso2_code" :props="props">
                                                            {{ props.row.iso2_code }}
                                                        </q-td>
                                                        <q-td  key="iso3_code" :props="props">
                                                            {{ props.row.iso3_code }}
                                                        </q-td>
                                                        <q-td  key="iso_numeric_code" :props="props">
                                                            {{ props.row.iso_numeric_code }}
                                                        </q-td>
                                                        <q-td  key="fips_code" :props="props">
                                                            {{ props.row.fips_code }}
                                                        </q-td>
                                                        <q-td  key="calling_code" :props="props">
                                                            {{ props.row.calling_code }}
                                                        </q-td>
                                                        <q-td  key="common_name" :props="props">
                                                            {{ props.row.common_name }}
                                                        </q-td>
                                                        <q-td  key="official_name" :props="props">
                                                            {{ props.row.official_name }}
                                                        </q-td>
                                                        <q-td  key="endonym" :props="props">
                                                            {{ props.row.endonym }}
                                                        </q-td>
                                                        <q-td  key="demonym" :props="props">
                                                            {{ props.row.demonym }}
                                                        </q-td>
                                                                ...
                                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                        <q-list dense rounded nav>
                                                                            <q-item link clickable v-ripple :to="`/countries/view/${props.row.id}`">
                                                                                <q-item-section>
                                                                                    <q-icon color="primary"  size="sm" name="visibility"></q-icon>
                                                                                </q-item-section>
                                                                                <q-item-section>View</q-item-section>
                                                                            </q-item>
                                                                            <q-item link clickable v-ripple :to="`/countries/edit/${props.row.id}`">
                                                                                <q-item-section>
...
<script>
	...
	export default {
		...
		computed: {
			...
			records: {
				get: function () {
					return this.$store.getters["countries/records"];
				},
				set: function (value) {
					this.$store.commit("countries/setRecords", value);
				},
			},
			currentRecord: {
				get: function () {
		...
		methods: {
			...mapActions("countries", ["fetchRecords", "deleteRecord"]),
			load: function() {
				if (!this.loading) {
					this.loading = true;
